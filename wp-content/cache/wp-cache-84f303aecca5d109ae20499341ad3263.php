...
<script type='text/javascript'>
/* <![CDATA[ */
var wc_add_to_cart_params = {"ajax_url":"\/Pro_E_Store\/wp-admin\/admin-ajax.php","wc_ajax_url":"\/Pro_E_Store\/product\/mens-genuine-leather-jacket\/?wc-ajax=%%endpoint%%","i18n_view_cart":"View Cart","cart_url":"http:\/\/localhost:8888\/Pro_E_Store","is_cart":"","cart_redirect_after_add":"no"};
/* ]]> */
</script>
...
<div itemscope itemtype="http://schema.org/Product" id="product-88" class="post-88 product type-product status-publish has-post-thumbnail product_cat-leather product_cat-mens product_tag-coat product_tag-jacket product_tag-leather product_tag-mens first instock featured sold-individually shipping-taxable purchasable product-type-simple">
	<div class="row">
...
</p><input type="hidden" id="_wp_unfiltered_html_comment_disabled" name="_wp_unfiltered_html_comment_disabled" value="1374f4d200" /><script>(function(){if(window===window.parent){document.getElementById('_wp_unfiltered_html_comment_disabled').name='_wp_unfiltered_html_comment';}})();</script>
			</form>
			</div><!-- #respond -->
						</div>
				</div>
...
<script type='text/javascript' src='http://localhost:8888/Pro_E_Store/wp-includes/js/wp-embed.min.js?ver=4.7'></script>
	...
	<!--<![endif]-->
		...
		<li id="wp-admin-bar-logout"><a class="ab-item" href="http://localhost:8888/Pro_E_Store/wp-login.php?action=logout&#038;_wpnonce=16a525a8fc">Log Out</a>		</li></ul></div>		</li></ul>			</div>
						<a class="screen-reader-shortcut" href="http://localhost:8888/Pro_E_Store/wp-login.php?action=logout&#038;_wpnonce=16a525a8fc">Log Out</a>
					</div>
...
<!-- Cached page generated by WP-Super-Cache on 2016-12-17 23:04:07 -->
