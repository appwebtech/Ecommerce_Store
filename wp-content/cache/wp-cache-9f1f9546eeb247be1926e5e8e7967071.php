...
<link rel="alternate" type="application/rss+xml" title="Pro_E_Store &raquo; Mens Product Category Feed" href="http://localhost:8888/Pro_E_Store/product-category/mens/feed/" />
...
<script type='text/javascript'>
/* <![CDATA[ */
var wc_add_to_cart_params = {"ajax_url":"\/Pro_E_Store\/wp-admin\/admin-ajax.php","wc_ajax_url":"\/Pro_E_Store\/product-category\/mens\/?wc-ajax=%%endpoint%%","i18n_view_cart":"View Cart","cart_url":"http:\/\/localhost:8888\/Pro_E_Store","is_cart":"","cart_redirect_after_add":"no"};
/* ]]> */
</script>
...
<body class="archive tax-product_cat term-mens term-20 logged-in admin-bar no-customize-support woocommerce woocommerce-page wpb-js-composer js-comp-ver-4.12 vc_responsive">
...
<script>
    ...
    "use strict";
		...
		<div  class="shop_header with_featured_img  with_parallax"> 
			   ...
			   <div data-stellar-background-ratio="0.5"					 class="shop_header_bkg  parallax" style="background-image:url(http://localhost:8888/Pro_E_Store/wp-content/uploads/2016/12/suit-975426_1920-e1482011289108.jpg)">
			   </div>
                ...
                <div class="large-12 large-centered columns">
                    ...
                    <div class="row">
                        <div class="large-9 large-centered columns">
                            <div class="term-description"><p>We got what you&#8217;re looking for. London, Rome, Milan, Venice, New York, Cardiff, Edinburgh, Munchen, Berlin, wherever you are, we got you covered. </p>
</div><div class="woocommerce_category_header_image"><img src="http://localhost:8888/Pro_E_Store/wp-content/uploads/2016/12/suit-975426_1920-e1482011289108.jpg" style="width:100%; height:auto; margin:0 0 20px 0" /></div>                        </div><!--.large-9-->
                    </div><!--.row-->
                         ...
                         <ul class="list_shop_categories list-centered">
                                    ...
                                    <li class="category_item">
                                        <a href="http://localhost:8888/Pro_E_Store/product-category/mens/accessories-mens/" class="category_item_link">
...
</aside><aside id="woocommerce_price_filter-2" class="widget woocommerce widget_price_filter"><h3 class="widget-title">Filter by price</h3><form method="get" action="http://localhost:8888/Pro_E_Store/product-category/mens/">
			<div class="price_slider_wrapper">
				<div class="price_slider" style="display:none;"></div>
				<div class="price_slider_amount">
					<input type="text" id="min_price" name="min_price" value="" data-min="120" placeholder="Min price" />
					<input type="text" id="max_price" name="max_price" value="" data-max="285" placeholder="Max price" />
...
<li class="cat-item cat-item-20 current-cat cat-parent"><a href="http://localhost:8888/Pro_E_Store/product-category/mens/">Mens</a> <span class="count">(2)</span><ul class='children'>
...
<li class="">
	...
	<span class="price"><span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">&pound;</span>120.00</span></span>
					...
					<div class="product_after_shop_loop_buttons">
						</a><a rel="nofollow" href="/Pro_E_Store/product-category/mens/?add-to-cart=120" data-quantity="1" data-product_id="120" data-product_sku="AWT-75284-124776" class="button product_type_simple add_to_cart_button ajax_add_to_cart">Add to cart</a>					</div>
...
<li class="">
	...
	<span class="price"><span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">&pound;</span>285.00</span></span>
					...
					<div class="product_after_shop_loop_buttons">
						</a><a rel="nofollow" href="/Pro_E_Store/product-category/mens/?add-to-cart=88" data-quantity="1" data-product_id="88" data-product_sku="AWT-95284-122016" class="button product_type_simple add_to_cart_button ajax_add_to_cart">Add to cart</a>					</div>
...
<script type='text/javascript'>
/* <![CDATA[ */
var woocommerce_params = {"ajax_url":"\/Pro_E_Store\/wp-admin\/admin-ajax.php","wc_ajax_url":"\/Pro_E_Store\/product-category\/mens\/?wc-ajax=%%endpoint%%"};
/* ]]> */
</script>
...
<script type='text/javascript'>
/* <![CDATA[ */
var wc_cart_fragments_params = {"ajax_url":"\/Pro_E_Store\/wp-admin\/admin-ajax.php","wc_ajax_url":"\/Pro_E_Store\/product-category\/mens\/?wc-ajax=%%endpoint%%","fragment_name":"wc_fragments"};
/* ]]> */
</script>
...
<script type='text/javascript' src='http://localhost:8888/Pro_E_Store/wp-content/plugins/woocommerce/assets/js/frontend/price-slider.min.js?ver=2.6.9'></script>
	...
	<!--<![endif]-->
		...
		<li id="wp-admin-bar-customize" class="hide-if-no-customize"><a class="ab-item" href="http://localhost:8888/Pro_E_Store/wp-admin/customize.php?url=http%3A%2F%2Flocalhost%3A8888%2FPro_E_Store%2Fproduct-category%2Fmens%2F">Customize</a>		</li>
		...
		<li id="wp-admin-bar-edit"><a class="ab-item" href="http://localhost:8888/Pro_E_Store/wp-admin/term.php?taxonomy=product_cat&#038;tag_ID=20&#038;post_type=product">Edit Product Category</a>		</li>
...
<!-- Cached page generated by WP-Super-Cache on 2016-12-17 23:30:14 -->
