...
<script type='text/javascript' src='http://localhost:8888/Pro_E_Store/wp-includes/js/wp-embed.min.js?ver=4.7'></script>
	...
	<!--<![endif]-->
		...
		<li id="wp-admin-bar-logout"><a class="ab-item" href="http://localhost:8888/Pro_E_Store/wp-login.php?action=logout&#038;_wpnonce=0b1f12d4ce">Log Out</a>		</li></ul></div>		</li></ul>			</div>
						<a class="screen-reader-shortcut" href="http://localhost:8888/Pro_E_Store/wp-login.php?action=logout&#038;_wpnonce=0b1f12d4ce">Log Out</a>
					</div>
